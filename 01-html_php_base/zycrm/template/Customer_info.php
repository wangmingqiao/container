<?php include_once __DIR__.DIRECTORY_SEPARATOR.'Common_header.php'?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
                <div class="row">
                    <h2 class="col-sm-2">客户信息</h2>
                    <a class="btn btn-info col-sm-offset-9" href="/action.php?act=customer_info&step=add">添加</a>
                </div>
        ...
        <div class="panel-body">
            ...
            <table class="table table-hover table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <?php endforeach; ?>
                    <td>
                        <a href="/action.php?act=customer_info&step=edit&id=<?php echo $info['id']?>">编辑</a>/
                        <a href="/action.php?act=customer_info&step=del&id=<?php echo $info['id']?>">删除</a>
                    </td>
                </tr>
                <?php endforeach; ?>
